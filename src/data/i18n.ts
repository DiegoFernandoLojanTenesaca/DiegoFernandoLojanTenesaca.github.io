export const translations: Record<string, Record<string, string>> = {
  ...
  "proj.riksi.desc": {
    es: "Identificador de fauna y flora del Ecuador que corre entero dentro del navegador, sin cuenta y sin internet: EfficientNet-Lite0 a 288 px con 100 especies, 3,8 MB cuantizado a 8 bits y validado sobre 1.000 imágenes que el modelo no vio al entrenar. Pensado para el páramo, Galápagos y el Yasuní, que es justo donde no hay señal y donde falla cualquier herramienta que dependa de un servidor. Incluye además 74 aves reconocibles por su canto.",
    en: "Ecuadorian wildlife and plant identifier that runs entirely inside the browser, with no account and no internet: EfficientNet-Lite0 at 288 px over 100 species, 3.8 MB quantized to 8 bits and validated on 1,000 images the model never saw during training. Built for the páramo, Galápagos and Yasuní, exactly where there is no signal and any server-bound tool fails. It also recognizes 74 birds by their song.",
  },
  "proj.yachaq.desc": {
    es: "Agente de herramientas montado sobre el modelo de Riksi: decide por su cuenta qué consultar entre el clasificador, GBIF en vivo y 691 fichas de especies, y recuerda con quién habla. Cada respuesta declara qué herramientas usó, que es la diferencia entre haber consultado los registros y habérselo inventado. Corre en Northflank con 0,2 vCPU y 512 MB, y se expone como API, contenedor Docker o servidor MCP.",
    en: "Tool-calling agent built on top of the Riksi model: it decides on its own what to consult among the classifier, live GBIF and 691 species sheets, and remembers who it is talking to. Every answer states which tools it used, which is the difference between having checked the records and having made it up. Runs on Northflank with 0.2 vCPU and 512 MB, exposed as an API, a Docker container or an MCP server.",
  },
  "proj.riksiradar.desc": {
    es: "Pipeline que audita a GBIF: cada día toma observaciones de fauna del Ecuador, las pasa por el modelo de Riksi sin enseñarle la etiqueta y guarda las dos respuestas, la de la persona y la de la máquina. GBIF a Kafka a 6.000 registros diarios, clasificación, DuckDB y modelado con dbt. Sobre 400 observaciones reales, 337 coinciden y 63 no, y los desacuerdos tienen sentido biológico: el radar los ordena por confianza en lugar de arrogarse una autoridad que no tiene.",
    en: "A pipeline that audits GBIF: every day it takes Ecuadorian wildlife observations, runs them through the Riksi model without showing it the label and stores both answers, the human one and the machine one. GBIF into Kafka at 6,000 records a day, classification, DuckDB and dbt modelling. Across 400 real observations, 337 agree and 63 do not, and the disagreements make biological sense: the radar ranks them by confidence instead of claiming an authority it does not have.",
  },
  "proj.yapa.desc": {
  ...
  "proj.officego.desc": {
    ...
    en: "Graphical Microsoft Office installer for Windows, built with M. Salazar. Profiles the machine (Windows version, RAM, disk) to recommend a viable edition, generates the Office Deployment Tool configuration.xml and supports unattended mode via parameters. Two front-ends over one shared engine (PowerShell/WinForms and Tauri), with an automated test suite and a layout validator running on every build.",
  },
  ...
  "proj.cuadrekit.desc": {
    es: "El kit del micronegocio: herramientas gratuitas para micronegocios y freelancers de Ecuador (proformas, recibos, contratos, pagarés, liquidaciones, rol de pagos y horas extra según el Código del Trabajo). PWA instalable que funciona sin internet, sin registro y sin que los datos salgan del equipo.",
    en: "The micro-business kit: free tools for Ecuadorian micro-businesses and freelancers (quotes, receipts, contracts, promissory notes, severance calculations, payroll and overtime under the Labor Code). Installable PWA that works offline, with no sign-up and no data leaving your device.",
  },
  ...
  "proj.sudialai.desc": {
    es: "Microservicio de IA en producción con arquitectura DDD multi-tenant y 18 dominios funcionales. Búsqueda semántica sobre 139.000 conversaciones vectorizadas con embeddings BGE-M3 e índice HNSW en pgvector, agente conversacional con 15 herramientas de tool calling, pipelines de Vision-Language Models self-hosted en GPU, clasificación zero-shot, OCR estructurado, transcripción local y moderación.",
    en: "Production AI microservice with multi-tenant DDD architecture and 18 functional domains. Semantic search over 139,000 vectorized conversations with BGE-M3 embeddings and an HNSW index in pgvector, a conversational agent with 15 tool-calling tools, self-hosted Vision-Language Model pipelines on GPU, zero-shot classification, structured OCR, local transcription and moderation.",
  },
  "proj.kumbre.desc": {
